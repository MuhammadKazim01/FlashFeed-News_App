...
export default function About() {
  document.title = "About - FlashFeed";
  return (
    <>
      <div className="text-center">
        <div className="container">
          <div className="container mt-4 mb-5">
            ...
            <p className="h5">
              Welcome to FlashFeed, your go-to destination for captivating
          ...
          <div className="container mb-5">
            ...
            <p className="h5">
              Our mission at FlashFeed is to provide users with easy access to
          ...
          <div className="container mb-5">
            ...
            <p className="h5">
              FlashFeed offers a wide range of headline coverage, including news
          ...
          <div className="container">
            <p className="h5">
              Thank you for choosing FlashFeed for your headline needs. We're
